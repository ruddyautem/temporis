          ...
          <div className='bg-[#0d1621]/80 backdrop-blur-xl border border-slate-700/60 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden'>
            ...
            <div className='p-8 sm:p-10 md:p-12 space-y-8 md:space-y-10'>
              ...
              <div className='space-y-4 md:space-y-5'>
                ...
                <div className='bg-[#0a1118] border border-slate-700 p-5 md:p-6 flex items-center justify-center transition-all rounded-xl'>
                  <div className='inline-flex items-center gap-4 text-base md:text-lg text-emerald-200/80'>
              ...
              <div className='flex flex-col sm:flex-row gap-3 md:gap-4 pt-2'>
                <button
                  onClick={onJoin}
                  className='flex-1 bg-emerald-500/10 border border-emerald-400/20 text-emerald-300 p-5 md:p-6 text-[12px] md:text-[13px] font-bold uppercase tracking-[0.3em] hover:bg-emerald-500/20 transition-all cursor-pointer active:scale-95 rounded-xl'
                >
                  Rejoindre Room
                </button>
                <button
                  onClick={onDecline}
                  className='flex-1 bg-red-500/5 border border-red-500/20 text-red-400/80 p-5 md:p-6 text-[12px] md:text-[13px] font-bold uppercase tracking-[0.3em] hover:bg-red-500/10 hover:text-red-400 transition-all cursor-pointer active:scale-95 rounded-xl'
                >
                  Retour Accueil
                </button>
              </div>
